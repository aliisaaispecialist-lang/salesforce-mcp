    ...
    query: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                "'+973 1234 5678'. Two characters minimum.\n\n"
                "It matches from the start of a word. 'Lovel' finds 'Lovelace' and "
                "so does 'Lov', but 'ovelace' and 'lace' find nothing: the beginning "
                "of the word has to be there. Send the first part of a name, never "
                "the end of it. A search that matches nothing returns an empty list "
                "rather than an error, so try a shorter prefix before deciding the "
                "person is not in Salesforce -- deciding that wrongly is how a "
                "duplicate contact gets created.\n\n"
