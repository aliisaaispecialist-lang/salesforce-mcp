...
### B3. `/presentation` slides 2 to 14: unread
A 14-slide kickoff deck; only slide 1 was retrievable (the browser extension was disconnected during research). Slides 2 to 14 may contain requirements not on the homepage. Re-runnable if the Chrome extension is reconnected.
